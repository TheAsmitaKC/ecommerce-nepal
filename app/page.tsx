  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 items-center pl-5 lg:grid-cols-6 md:grid-cols-4">
        ...
        />
        <ShopByTopCategories
          image={<Image src={top2} alt="" />}
          title="Fresh Vegetables"
        />
        <ShopByTopCategories
          image={<Image src={top3} alt="" />}
          title="Meat & Fish"
        />
        <ShopByTopCategories
          image={<Image src={top4} alt="" />}
          title="Snacks"
        />
        <ShopByTopCategories
          image={<Image src={top5} alt="" />}
          title="Beverages"
        />
        <ShopByTopCategories
          image={<Image src={top6} alt="" />}
          title="Beauty & Health"
        />
        <ShopByTopCategories
          image={<Image src={top7} alt="" />}
          title="Bread & Bakeries"
        />
        <ShopByTopCategories
          image={<Image src={top8} alt="" />}
          title="Baking Needs"
        />
        <ShopByTopCategories
          image={<Image src={top9} alt="" />}
          title="Cooking"
        />
        <ShopByTopCategories
          image={<Image src={top10} alt="" />}
          title="Diabetic Food"
        />
        <ShopByTopCategories
          image={<Image src={top11} alt="" />}
